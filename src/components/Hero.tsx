      ...
      <section className="hero" aria-labelledby="hero-title">
        ...
        <div className="hero__inner">
          ...
          <h1 className="hero__title" id="hero-title">
            Glamour
            <span className="hero__title-highlight">Studio</span> para tu próxima transformación
          </h1>
          <p className="hero__subtitle">
            Cabello, maquillaje y uñas en un solo lugar. Un equipo de especialistas listo para que
            salgas sintiéndote increíble, sin dramas y con mucho estilo.
          </p>
